public class TestEnsembleVoituresAutorisees{
	...
	public static void main(String[] args) {	
		...
		if (e.retirerVoiture(new Voiture("1BBB000",""))){
			System.out.println("Attention, la voiture n'était plus dans l'ensemble mais votre méthode annonce que si");
		}
		if (e.voitureAutorisee(p1BBB000)){
			System.out.println("Attention, la voiture n'est plus autorisée alors qu'ici oui");
		}
		

		System.out.println("Cas 6 : nouvelle verification de la presence des voitures 1AAA000 et 1CCC000");
		if (!e.voitureAutorisee(new Voiture("1AAA000",""))){
			System.out.println("Attention, la voiture devrait toujours être présente");
		}
		if (!e.voitureAutorisee(new Voiture("1CCC000",""))){
			System.out.println("Attention, la voiture devrait toujours être présente");
		}
		...
		if (e.ajouterVoiture(new Voiture("1AAA000",""))){
			System.out.println("La voiture ne devrait pas être ajoutée");
		}

		System.out.println("Tous les tests ont reussis !");
	}
